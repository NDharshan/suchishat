  ...
  return (
    <div className="text-center bg-white text-gray-800 py-24 px-6">
      <h1 className="text-5xl md:text-6xl xl:text-7xl font-bold tracking-tight mb-12">
        <span className="capitalize">Bring all your projects to life on</span>
        <br />
        <span className="text-green-600">SAMVIT.</span>
      </h1>
      <button
        className="inline-block px-7 py-3 mr-2 bg-blue-600 text-white font-medium text-sm
        leading-snug uppercase shadow-md hover:bg-blue-700 hover:shadow-lg
        focus:bg-blue-700 focus:shadow-lg focus:outline-none focus:ring-0 rounded-full
      ...
      <button
        className="inline-block px-7 py-3 bg-transparent text-blue-600 font-medium text-sm
